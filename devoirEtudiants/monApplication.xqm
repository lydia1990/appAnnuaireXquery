 ...
 function page:annuaire()
 {
  xls:template(
       <form id="annuaire" method="POST" action="updateAnnuaire">
         <p><label>Name:</label><input type="text" name="nom" placeholder="Tapez votre nom..."/></p>
         <p><label>Firstname:</label><input type="text" name="prenom" placeholder="Tapez votre prénom..."/></p>
         <p><label>Adress:</label><input type="text" name="adresse" placeholder="Tapez votre adresse..."/></p>
          <p><label>Birthday:</label><input type="text" name="birthday" placeholder="Tapez votre date de naissance..."/></p>
           <p><label>Food:</label><input type="text" name="food" placeholder="Tapez votre fruit préféré..."/></p>
        ...
        return
         <div class="entry">
          ...
          <div class="adresse">{$x/adresse}</div>
           <div class="birthday">{$x/birthday}</div>
            <div class="food">{$x/food}</div>
          <div id="menuFloat">
 ...
 function page:annuaireCorrect($id)
 {
  xls:template(
     ...
     <form method="POST" action="/updateEntryAnnuaire">
       ...
       <p><label>Birthday:</label><input type="text" name="birthday" value="{db:open('annuaireTilde')/bdd/entry[@id=$id]/birthday}"/></p>
        <p><label>Food:</label><input type="text" name="food" 
    value="{db:open('annuaireTilde')/bdd/entry[@id=$id]/food}"/></p>
